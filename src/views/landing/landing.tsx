    ...
    <div className={css(styles.parent)}>
      ...
      <Container style={styles.special}>
        <Section title="About me">
          <div>
            I was born in 1997 in Morelia, Michoacán, city of the pink quarry.
            I've been living here since then. From a young age I showed a
            remarkable fascination about how things work. I remember
            disassembling an old radio from my father just to see what was
            inside. I didn't assembly it back. <br />
            <br /> I started studying engineering in computer systems in 2015 at
            the age of 18 at the Instituto Tecnológico de Morelia, and I've got my degree in 2021. I have an special interest in web
            technologies, such as web developing, mobile apps, backend
            technologies and cloud computing. I'm also planning to study a
            master on Data Science after graduating. <br />
            ...
            <br /> I love movies, I love music and I love to roadtrip.
          </div>
        </Section>
